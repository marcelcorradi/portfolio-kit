---
name: Portfolio Kit
description: A portfolio site you build with AI, not a template you rename. Ships a production Vite + React + Tailwind + shadcn foundation plus a set of Claude Code skills that interview you, then design your pages and write your case studies with you, grounded in a real portfolio-writing methodology, in your voice, in your look. Run /setup and the skills configure the whole site from your answers; then build the home and write cases one section at a time. Includes a Markdown case engine, per-route SEO, and a GitHub Pages deploy workflow.
---
...
- **Claude Code skills** in `.claude/skills/`:
  ...
  - `update`: applies a new kit version (`/update`) without overwriting your work.
